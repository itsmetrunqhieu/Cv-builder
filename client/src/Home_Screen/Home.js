...
function Home() {
    ...
    const [searchITCV, setSearchITCV] = useState(false);
    const [searchBACV, setSearchBACV] = useState(false);

    useEffect(() => {
        // Kiểm tra xem searchQuery có giá trị "IT" hay không
        setSearchITCV(searchQuery.toUpperCase() === "IT");
        setSearchBACV(searchQuery.toUpperCase() === "BA");
    }, [searchQuery]);
    ...
    const handleSearchSubmit = (e) => {
        e.preventDefault();
        // Do something with the searchQuery, for example, send it to an API or perform a local search
    ...
    return (
        <div className='home'>
            <div className={`home-header ${scrollDirection}`}>
                <Link to='/'>
                    <p className='cv-buider-name' onClick={handleResetClick}>CV Builder</p>
                </Link>
                <ul className={`nav ${searchActive ? 'search-active' : ''}`}>
            ...
            {searchActive ? (
                <div className='search_resume_bg'>
                    {searchITCV ? (
                        <div>
                            <img
                ...
                <div>
                    <div className='part1'>
                        <div className='part1-main'>
                            ...
                            <Link to="/create-cv-options">
                                <button className='create-button hidden'>
                    ...
                    <div className='part3'>
                        <div className='part3-main'>
                            ...
                            <Link to="/create-cv-options">
                                <button className='create-button button-part3 hidden'>
                                    <p className='create-text'>CREATE MY CV</p>
                                </button>
                            </Link>
                        </div>
                    ...
                    <div className='part4'>
                        <div className='part4-main'>
                            ...
                            <Link to="/create-cv-options">
                                <button className='create-button button-part4 hidden'>
                                    <p className='create-text'>CREATE MY CV</p>
                                </button>
                            </Link>
                        </div>
